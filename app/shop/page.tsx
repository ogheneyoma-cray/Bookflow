            ...
            <div key={product.id} className="bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100 flex flex-col hover:shadow-md transition duration-300">
              ...
              <div className="p-6 flex flex-col gap-4 flex-1">
                <div className="flex justify-between items-start gap-2">
                  ...
                  <span className="font-bold text-[#2B2D42] font-['Montserrat',sans-serif] text-sm">
                ...
                <div className="mt-auto pt-4 flex gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 bg-[#D90429] text-white py-2.5 rounded-xl font-bold font-['Montserrat',sans-serif] hover:bg-[#b00320] transition flex items-center justify-center gap-2"
                  >
