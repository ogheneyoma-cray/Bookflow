      ...
      <section className="max-w-4xl mx-auto px-6 py-14">
        <div className="bg-white border border-[#D5C9B5] p-8 md:p-12 space-y-10 text-[#6B6147] leading-relaxed">
          ...
          <div>
            ...
            <p>For privacy queries, write to <a href="mailto:hello@crystalkeeper.com" className="text-[#C9A84C] hover:underline">hello@crystalkeeper.com</a> or call <a href="tel:+2349033609628" className="text-[#C9A84C] hover:underline">+234 903 360 9628</a>.</p>
          </div>
