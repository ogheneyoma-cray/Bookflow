      ...
      <section className="max-w-4xl mx-auto px-6 py-14">
        <div className="bg-white border border-[#D5C9B5] p-8 md:p-12 space-y-10 text-[#6B6147] leading-relaxed">
          ...
          <div>
            ...
            <p>If your parcel has not arrived within the estimated window, or if your tracking shows no movement for 5+ days, please contact us at <a href="mailto:hello@crystalkeeper.com" className="text-[#C9A84C] hover:underline">hello@crystalkeeper.com</a> or call <a href="tel:+2347088842059" className="text-[#C9A84C] hover:underline">+234 708 884 2059</a>. We will investigate with the courier immediately.</p>
          </div>
