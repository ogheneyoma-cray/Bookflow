      ...
      <div className="max-w-4xl mx-auto bg-white p-8 md:p-16 rounded-3xl shadow-sm border border-slate-100">
        ...
        <div className="space-y-8 text-slate-600 leading-relaxed">
          <section>
            ...
            <p>Because Bookxflow Publishing exclusively sells digital products (Ebooks), there are no physical items to be shipped. Therefore, no physical shipping fees, transit times, or customs delays apply to your order.</p>
          </section>
          ...
          <section>
            ...
            <p>If you do not receive your download email within 15 minutes of purchase (please check your spam/junk folder), or if you experience any issues downloading or opening your file, please contact us immediately at support@bookxflowpublishing.com.</p>
          </section>
        </div>
      </div>
    </main>
